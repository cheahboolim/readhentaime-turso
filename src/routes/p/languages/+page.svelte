...
<main class="max-w-6xl mx-auto px-4 py-8">
	...
	<header class="mb-8">
		...
		<p class="text-gray-600 dark:text-gray-300 mb-4">
			Discover hentai content in {data.totalLanguages} languages, organized alphabetically. Find your
			favorite translations and explore multilingual content.
		</p>
		<div
			class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4"
		>
			<p class="text-sm text-blue-800 dark:text-blue-200">
				<strong>Pro tip:</strong> Use the search bar to quickly find languages or browse by letter to
			...
			<div class="grid md:grid-cols-2 gap-6 mb-6">
				<div>
					...
					<p class="text-gray-600 dark:text-gray-300 text-sm">
						Browse our extensive list of hentai languages, organized alphabetically for easy
						navigation.
					</p>
				</div>
				<div>
					...
					<p class="text-gray-600 dark:text-gray-300 text-sm">
						Each language includes translated hentai content, allowing you to enjoy your favorite
						works in your preferred language.
					</p>
				</div>
			</div>
			<p class="text-gray-600 dark:text-gray-300 mb-4">
				Our language database helps you find and explore hentai content in various languages. Use
				the search feature or browse by letter to discover new translations.
			</p>
