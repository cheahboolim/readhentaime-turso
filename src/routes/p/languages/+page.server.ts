...
export const load: PageServerLoad = async ({ locals, url }) => {
  ...
  if (error || !languages) {
    ...
    return {
      ...
      availableLetters: [],
      seo: {
        title: 'Browse Hentai Languages | NHentai',
  ...
  return {
    ...
    availableLetters,
    seo: {
      title: `Browse ${totalLanguages}+ Hentai Languages A-Z | NHentai`,
      ...
      ogImage: 'https://nhentai.pics/images/languages-og.jpg',
      structuredData: {
        ...
        mainEntity: {
          ...
          itemListElement: languages.slice(0, 25).map((language, index) => ({
            ...
            item: {
              '@type': 'DefinedTerm',
              name: language.name,
              url: `https://nhentai.pics/language/${language.slug}`,
              inDefinedTermSet: {
                '@type': 'DefinedTermSet',
                name: 'Hentai Languages'
              }
