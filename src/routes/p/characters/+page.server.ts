...
export const load: PageServerLoad = async ({ locals, url }) => {
  ...
  if (error || !characters) {
    ...
    return {
      ...
      availableLetters: [],
      seo: {
        title: 'Browse Hentai Characters | NHentai',
  ...
  return {
    ...
    availableLetters,
    seo: {
      title: `Browse ${totalCharacters}+ Hentai Characters A-Z | NHentai`,
      ...
      ogImage: 'https://nhentai.pics/images/characters-og.jpg',
      structuredData: {
        ...
        mainEntity: {
          ...
          itemListElement: characters.slice(0, 25).map((character, index) => ({
            ...
            item: {
              '@type': 'Person',
              name: character.name,
              url: `https://nhentai.pics/character/${character.slug}`,
              inDefinedTermSet: {
                '@type': 'DefinedTermSet',
                name: 'Hentai Characters'
              }
