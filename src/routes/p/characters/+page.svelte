...
<main class="max-w-6xl mx-auto px-4 py-8">
	...
	<header class="mb-8">
		...
		<p class="text-gray-600 dark:text-gray-300 mb-4">
			Discover hentai characters from our collection of {data.totalCharacters} characters, organized
			alphabetically. Find your favorite characters from various hentai series and explore their stories.
		</p>
		<div
			class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4"
		>
			<p class="text-sm text-blue-800 dark:text-blue-200">
				<strong>Pro tip:</strong> Use the search bar to quickly find characters or browse by letter to
			...
			<div class="grid md:grid-cols-2 gap-6 mb-6">
				<div>
					...
					<p class="text-gray-600 dark:text-gray-300 text-sm">
						Browse our extensive list of hentai characters from various series, organized
				...
				<div>
					...
					<p class="text-gray-600 dark:text-gray-300 text-sm">
						Each character profile includes detailed information about their role, series, and
						appearances in hentai.
					</p>
				</div>
			</div>
			<p class="text-gray-600 dark:text-gray-300 mb-4">
				Our character database helps you find and explore your favorite hentai characters. Use the
				search feature or browse by letter to discover new characters and their stories.
			</p>
