...
<main class="max-w-3xl mx-auto px-4 py-12">
  ...
  <section class="space-y-6 text-base leading-relaxed">
    ...
    <div>
      ...
      <p>
        We may use cookies and third-party analytics tools (e.g. Google Analytics) to collect usage data and improve the service. You can disable cookies in your browser settings.
      </p>
    </div>
    ...
    <div>
      ...
      <p>
        We do not sell your data. We may share limited information with trusted service providers who help us operate the site, but only when necessary and under confidentiality agreements.
      </p>
    </div>
    ...
    <div>
      ...
      <p>
        You may request access to or deletion of your data by contacting us. If you use our site from the EU or other jurisdictions with privacy laws, you have specific rights under those laws.
      </p>
    </div>
    ...
    <div>
      ...
      <p>
        We may update this Privacy Policy from time to time. Any changes will be posted here, and your continued use of the site constitutes acceptance of those changes.
      </p>
    </div>
