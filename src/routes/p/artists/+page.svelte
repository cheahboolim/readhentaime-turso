	...
	<header class="mb-8">
		...
		>
			<p class="text-sm text-blue-800 dark:text-blue-200">
				<strong>Pro tip:</strong> Use the search bar to quickly find artists or browse by letter to explore
				the full list.
			</p>
		</div>
	</header>
			...
			<div class="grid md:grid-cols-2 gap-6 mb-6">
				<div>
					...
					<p class="text-gray-600 dark:text-gray-300 text-sm">
						Browse our extensive list of hentai artists from various series, organized
				...
				<div>
					...
					<p class="text-gray-600 dark:text-gray-300 text-sm">
						Each artist profile includes detailed information about their works, style, and
						contributions to hentai.
					</p>
				</div>
			</div>
			<p class="text-gray-600 dark:text-gray-300 mb-4">
				Our artist database helps you find and explore your favorite hentai creators. Use the search
				feature or browse by letter to discover new artists and their works.
			</p>
